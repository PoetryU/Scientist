...
QuantumultX:
[rewrite_local]
^https:\/\/buy\.itunes\.apple\.com\/verifyReceipt url script-response-body https://raw.githubusercontent.com/PoetryU/Scientist/master/Scripts/iRightMouse.js
[mitm]
...
Surge4 or Loon:
[Script]
http-response ^https:\/\/buy\.itunes\.apple\.com\/verifyReceipt script-path=https://raw.githubusercontent.com/PoetryU/Scientist/master/Scripts/iRightMouse.js, requires-body=true, tag=iRightMouse
[MITM]
hostname = buy.itunes.apple.com
*/
...
if (bundle_id == "cn.better365.iRightMouse") {
    obj = {
        status: 0,
        ...
        receipt: {
            ...
            adam_id: 1497428978,
            app_item_id: 1497428978,
            bundle_id: "cn.better365.iRightMouse",
            application_version: "2.2.3",
        ...
        pending_renewal_info: [
            {
                auto_renew_product_id: "20210123",
                product_id: "20210123",
                original_transaction_id: "160001146523849",
                auto_renew_status: "1"
            }
